...
<body class="bg-light">
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button"
                                        ...
                                        class="btn text-secondary shadow-none border-dark"
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed to book cars, when shutdown mode is turned on
                        </p>
                    </div>
                </div>
    ...
    <script>
        ...
        function upd_general(site_title_val, site_about_val) {
            ...
            xhr.onload = function () {
                //hiding bootstrap modal via bootstrap js getInstance 
        ...
        function upd_shutdown(val) {
            ...
            xhr.onload = function () {
                if (this.responseText == 1 && general_data.shutdown == 0) {
                    alert('success', 'Site has been shutdowned!');
                    get_general();
                } else {
        ...
        function get_contacts() {
            let contacts_p_id = ['address','gmap','pn1','pn2','email','fb','tw','git'];
        ...
        {
          let contacts_inp_id = ['address_inp','gmap_inp','pn1_inp','pn2_inp','email_inp','fb_inp','tw_inp','git_inp','iframe_inp'];
        ...
        {
          let index = ['address','gmap','pn1','pn2','email','fb','tw','git'];
          let contacts_inp_id = ['address_inp','gmap_inp','pn1_inp','pn2_inp','email_inp','fb_inp','tw_inp','git_inp','iframe_inp'];
